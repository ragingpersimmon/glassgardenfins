...
const ROUTES = [
  ...
  '/journal/how-much-sun-do-fish-need/',
  '/journal/what-happened-to-my-shrimps-skin/',
  '/journal/why-is-my-fish-staying-at-the-bottom/',
  '/journal/why-is-my-fish-swimming-at-the-top/',
  '/journal/how-often-should-you-change-aquarium-water/',
  '/journal/why-is-my-aquarium-water-cloudy/',
  '/journal/is-my-aquarium-filter-big-enough/',
  '/journal/how-many-fish-can-i-put-in-my-aquarium/',
  '/journal/why-are-my-aquarium-plants-turning-brown/',
